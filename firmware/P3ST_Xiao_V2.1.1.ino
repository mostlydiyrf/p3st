// Arduino "sketch" for use with the P3ST Xiao Digital VFO/BFO (v.2.1.1)
...
void si5351CorrectionFactor() {
  ...
  saveInt(10, correctionFactor + 10000);  // Pad correctionFactor with 10000 to prevent integer underflow
                                          // of negative values.
